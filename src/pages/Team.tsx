...
const teamMembers = [
  ...
  { name: 'Liam Anderson', role: 'Chief Operations Officer', category: 'Executives', image: 'https://static.clubs.nfl.com/image/private/t_editorial_landscape_12_desktop/colts/wgisnda55eq49c1hinzm', description: 'Liam oversees day-to-day operations.', socials: { linkedin: '#', twitter: '#' }},
